  ...
  return async (state: GraphState): Promise<Partial<GraphState>> => {
    ...
    try {
      ...
      const details = {
        ...
        seatingPreference: state.seatingPreference,
        specialOccasion: state.specialOccasion,
      ...
      if (result.error) {
        ...
        return {
          messages: [
            ...state.messages,
            new AIMessage('Desculpe, houve um problema ao gerar a resposta. Por favor, tente novamente.'),
          ],
        };
      }
